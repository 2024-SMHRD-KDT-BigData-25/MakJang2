            ...
            <div class="board_write">
                <div class="title">
                    <dl>
                        <dt>제목</dt>
                        <dd>
                            <input type="text" name="meTitle" id="me_title" placeholder="제목 입력">
                        </dd>
                    </dl>
                </div>
                <div class="info">
                    ...
                    <dl>
                        <dt>참여인원</dt>
                        <dd>
                            <select name="mePeople" id="people">
...
<script>
    ...
    function submitForm() {
        ...
        // 참여 인원이 2명 이상이어야 함
        if (parseInt(people) < 2) {  // people 값을 숫자로 변환하여 검사
            alert("참여 인원은 최소 2명 이상이어야 합니다.");
            return false;
        }
