...
<%
	...
	// 조회수 증가
    dao.increasecrHitCount(idx);
	
	MyBoard board = dao.getcrBoard(idx);  // 게시글 정보 가져오기
	
	// 댓글 리스트 가져오기
	CommentDAO commentDAO = new CommentDAO();
	List<Comment> commentList = commentDAO.getcrCommentsByBoardId(idx);  // 게시글 ID로 댓글 목록 가져오기  
    ...
    <div class="board_wrap">
        ...
        <div class="board_view_wrap">
            <div class="board_view">
                <div class="title">
                    <%=board.getCR_TITLE().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %> <!-- input-->
                </div>
                <div class="info">
                    <dl>
                        <dt>번호</dt>
                        <dd><%=board.getCR_NO() %></dd>
                    </dl>
                    <dl>
                        <dt>글쓴이</dt>
                    ...
                    <dl>
                        <dt>작성일</dt>
                        <dd><%=board.getCR_WRITEDATE() %></dd>
                    </dl>
                    <dl>
                        <dt>조회</dt>
                        <dd><%=board.getCR_HIT() %></dd>
                    </dl>
                  ...
                  <% if (board.getUS_EMAIL().equals(email)){ %>
				    ...
				    <dl>
				    <dt><a href="updateBoardForm.jsp?No=<%= board.getCR_NO() %>" class="btn btn-warning">게시글 수정</a></dt>
				    </dl>
				<% } %>
