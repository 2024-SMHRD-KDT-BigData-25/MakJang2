...
<%
    ...
    MyBoard board = dao.getfrBoard(No);
%>
...
<form action="updateBoard.do" method="post" onsubmit="return submitForm();">  <!-- onsubmit 추가 -->
    ...
    <div class="board_write_wrap">
        <div class="board_write">
            <div class="title">
                <dl>
                    <dt>제목</dt>
                    <dd>
                        <input type="text" name="meTitle" value="<%= board.getFR_TITLE() %>" required>
                    </dd>
                </dl>
            </div>
            ...
            <div class="cont">
                <dl>
                    ...
                    <div id="editor-container" style="height: 300px;">
                        <%= board.getFR_CONTENT() %>  <!-- 기존 게시글 내용을 Quill에 표시 -->
                    </div>
                    </dd>
                </dl>
            </div>
        ...
        <div class="bt_wrap">
            ...
            <a href="meetingview.jsp?No=<%= board.getFR_NO() %>" class="btn btn-secondary">취소</a>
        </div>
   	 </div>
</form>
    </div>
